...
public class PerguntaAtaque extends Dialog {
	 ...
	 * @param style
	 */
	public PerguntaAtaque(Shell parent, int style, TabuleiroInterface tabuleiroInterface) {
		super(parent, style);
	...
	private void createContents(String pergunta, Jogador jogador) {
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseDown(MouseEvent e) {
				tabuleiroInterface.turnoAtaque(jogador, shell);
				shell.close();
			}
		});
