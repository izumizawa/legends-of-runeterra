...
public class JogadaAtaque extends Dialog {
	 ...
	 * @param style
	 */
	public JogadaAtaque(Shell parent, int style, TabuleiroInterface tabuleiro, Jogador jogador) {
		super(parent, style);
		setText("Ataque de " + jogador.verNome());
	 ...
	 */
	private void createContents(List<Carta> cartasEvocadas, List<Carta> cartasAtaque) {
		...
		ImpressaoCartas cartasAtaqueJogador1 = new ImpressaoCartas(shell, SWT.NONE, cartasAtaque, "Cartas de ataque de "+ jogador.verNome());
